...
const Registrar = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        //const response = await executeQuery(`INSERT INTO usuarios (nombre, genero, artista) VALUES ('${nombre}','${genero}','${artista}')`);
...
const actualizarUsuario = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { nombres, apellidos, email, contra, grado, edad, idusuario } = req.body;
    try {
        //const response = await executeQuery(`UPDATE usuarios SET nombre = '${nombre}', genero = '${genero}', artista = '${artista}' WHERE idcanciones= ${req.params.id}`);
